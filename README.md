...
4. Event Delegation হলো এমন একটি টেকনিক যেখানে আমরা প্রতিটি child element-এ আলাদা করে event না দিয়ে, তাদের common parent element-এ একটাই event listener বসাই — আর Event Bubbling ব্যবহার করে child কে handle করি। মানে Event Delegation Parent দিয়ে child handle করে
